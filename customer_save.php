...
if($_POST['mode']=="add"){
    ...
    $sql = "insert into customer(cus_id,cus_name,cus_add,cus_tel,cus_user,cus_pass) 
            values('" . $_POST['cus_id'] . "','" . $_POST['cus_name'] . "','" . $_POST['cus_add'] . "',
            '" . $_POST['cus_tel'] . "','" . $_POST['cus_user'] . "','" . $_POST['cus_pass'] . "')";
    mysqli_query($connect, $sql);
}elseif($_POST['mode']=="edit"){
    $sql = "update customer set cus_name='" . $_POST['cus_name'] . "',cus_add='" . $_POST['cus_add'] . "',
            cus_tel='" . $_POST['cus_tel'] . "',cus_user='" . $_POST['cus_user'] . "',cus_pass='" . $_POST['cus_pass'] . "'
