                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" value="<?= $array['pa_date'] ?>" name="po_date" class="form-control" readonly>
                                                    </div>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="login-btn-inner">
                                            <div class="login-horizental cancel-wp text-center">
                                                <a class="btn btn-white" href="pay_previous.php">ย้อนกลับ</a>
                                                <a class="btn btn-sm btn-primary login-submit-cs" href="pay_print.php?id=<?=$_GET['id']?>&option=p" target="_blank"><i class="fa  fa-print" aria-hidden="true"></i> ปริ้น</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
