                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="all-form-element-inner">
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label class="login2 pull-right-pro">รหัสซ่อม</label>
                                                        <input type="text" value="<?= $autoid ?>" name="re_date" class="form-control" readonly>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label class="login2 pull-right-pro">วันที่ซ่อม</label>
                                                        <input type="text" value="<?= $array['re_date'] ?>" name="gc_doc" class="form-control" readonly>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" value="<?=$array3['gc_text']?>" name="gc_text" class="form-control" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="login-btn-inner">
                                            <div class="login-horizental cancel-wp text-center">
                                                <a class="btn btn-white" href="repair_previous.php">ย้อนกลับ</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
