...
<div class="container-fluid">
    <div class="product-status-wrap">
        <div class="row">
            <form action="reservation_save.php?mode=delete" method="POST">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="all-form-element-inner">
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <label class="login2 pull-right pull-right-pro">เหตุผลที่ยกเลิก<span style="color: red;">*</span></label>
                                                </div>
                                                <div class="col-md-6">
                                                    <textarea  name="rs_ex" class="form-control" rows="4" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group-inner">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="login-horizental cancel-wp text-center">
                                                            <a class="btn btn-white" href="reservation_list.php">ย้อนกลับ</a>
                                                            <button class="btn btn-sm btn-primary login-submit-cs" onclick="return confirm('คุณต้องการยกเลิกข้อมูลนี่ ? ')" type="submit">บันทึก</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
