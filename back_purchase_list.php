            ...
            <div class="col-md-12">
                <table class="table table-striped table-hover">
                    ...
                    if (isset($_GET['search'])) {
                        $sql = "select * from purchase_order where po_status = 0  and po_id like '%" . $_GET['po_id'] . "%'  order by po_id asc";
                    } else {
                        $sql = "select * from purchase_order where po_status = 0 order by po_id asc";
                    }
